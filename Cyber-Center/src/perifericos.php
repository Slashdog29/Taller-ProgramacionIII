...
<style>
    ...
    .glass-card { padding: 2rem !important; overflow: hidden; border: 1px solid rgba(255, 255, 255, 0.1); background: rgba(255,255,255,0.03); border-radius: 24px; }
...
<div class="container main-content pb-5">
    <div class="glass-card mb-4">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
            <div>
                <h5 class="text-white mb-1">Periféricos</h5>
    ...
    <div class="modal fade" id="perifericoModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content glass-modal text-white" style="background:#222;">
                <div class="modal-header">
                    <h5 class="modal-title">Registrar Periférico</h5>
                ...
                <div class="modal-body">
                    <form method="post" id="perifericoForm" class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="tipo_periferico_id" class="form-select bg-dark text-white" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="computadora_id" class="form-select bg-dark text-white">
                        ...
                        <div class="col-md-6">
                            <label class="form-label">Código Bien</label>
                            <input name="codigo_bien_nacional" class="form-control bg-dark text-white" required>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Serial</label>
                            <input name="numero_serial_fabrica" class="form-control bg-dark text-white" required>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <input name="modelo" class="form-control bg-dark text-white" required>
                        </div>
                        <div class="col-md-4">
                            <label class="form-label">Color</label>
                            <input name="color" class="form-control bg-dark text-white">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label">Estado</label>
                            <select name="estado_fisico" class="form-select bg-dark text-white">
                        ...
                        <div class="col-md-4 d-flex align-items-end">
                            <button class="btn btn-primary w-100" type="submit">Guardar Periférico</button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <div class="modal fade" id="editPerifericoModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content glass-modal text-white" style="background:#222;">
                <div class="modal-header">
                    <h5 class="modal-title">Editar Periférico</h5>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body">
                    <form method="post" id="editPerifericoForm" class="row g-3">
                        ...
                        <div class="col-md-6">
                            <label class="form-label">Tipo</label>
                            <select name="tipo_periferico_id" id="edit_tipo" class="form-select bg-dark text-white" required>
                                <option value="">-- Seleccione --</option>
                                <?php if ($tiposRes): mysqli_data_seek($tiposRes, 0); while ($t = mysqli_fetch_assoc($tiposRes)): ?>
                                    <option value="<?php echo intval($t['id']); ?>"><?php echo htmlspecialchars($t['nombre_componente']); ?></option>
                                <?php endwhile; endif; ?>
                        ...
                        <div class="col-md-6">
                            <label class="form-label">Equipo (opcional)</label>
                            <select name="computadora_id" id="edit_computadora" class="form-select bg-dark text-white">
                                <option value="">-- Ninguno --</option>
                                <?php if ($computadorasRes): mysqli_data_seek($computadorasRes, 0); while ($c = mysqli_fetch_assoc($computadorasRes)): ?>
                                    <option value="<?php echo intval($c['id']); ?>"><?php echo 'PC-'.str_pad(intval($c['numero_puesto']),2,'0',STR_PAD_LEFT) . ' ' . htmlspecialchars($c['direccion_ip'] ?? ''); ?></option>
                                <?php endwhile; endif; ?>
                        ...
                        <div class="col-md-6">
                            <label class="form-label">Código Bien</label>
                            <input name="codigo_bien_nacional" id="edit_codigo" class="form-control bg-dark text-white" required>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Serial</label>
                            <input name="numero_serial_fabrica" id="edit_serial" class="form-control bg-dark text-white" required>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Marca</label>
                            <input name="marca" id="edit_marca" class="form-control bg-dark text-white" list="marcasDataList" required autocomplete="off">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Modelo</label>
                            <input name="modelo" id="edit_modelo" class="form-control bg-dark text-white" required>
                        </div>
                        <div class="col-md-4">
                            <label class="form-label">Color</label>
                            <input name="color" id="edit_color" class="form-control bg-dark text-white">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label">Estado</label>
                            <select name="estado_fisico" id="edit_estado" class="form-select bg-dark text-white">
                                <option value="excelente">Excelente</option>
                                <option value="bueno">Bueno</option>
                                <option value="regular">Regular</option>
                                <option value="dañado">Dañado</option>
                        ...
                        <div class="col-md-4 d-flex align-items-end">
                            <button class="btn btn-warning w-100 text-dark font-weight-bold" type="submit">Actualizar Cambios</button>
                        </div>
                    </form>
                </div>
            </div>
                ...
                <div class="modal-body">
                    <form id="marcaForm" onsubmit="return false;">
                        <div class="mb-3">
                            ...
                            <input id="brandName" class="form-control bg-dark text-white" required autocomplete="off">
                        </div>
            ...
            <table class="table">
                ...
                <tbody>
                    <?php if (mysqli_num_rows($resultado) === 0): ?>
                        <tr><td colspan="9" class="text-center text-white-50 py-4">No hay periféricos registrados.</td></tr>
                    <?php else: ?>
                        <?php while ($row = mysqli_fetch_assoc($resultado)): ?>
                            <tr>
                                <td><?php echo intval($row['id']); ?></td>
                                <td><?php echo htmlspecialchars($row['nombre_componente'] ?? 'Sin tipo'); ?></td>
                                <td><?php echo htmlspecialchars(!empty($row['numero_puesto']) ? 'PC-' . str_pad($row['numero_puesto'], 2, '0', STR_PAD_LEFT) : 'No asignado'); ?></td>
                                <td><?php echo htmlspecialchars($row['codigo_bien_nacional'] ?? '-'); ?></td>
                                ...
                                <td>
                                    <button class="btn btn-sm btn-warning btn-edit-periferico" 
